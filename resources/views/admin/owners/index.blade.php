            ...
            <div class="container md:px-5  mx-auto">
              ...
              <div class="flex justify-end mb-4">
                <button onclick="location.href='{{ route('admin.owners.create')}}' "
                  class=" text-white bg-yellow-500 border-0 py-2 px-8 focus:outline-none hover:bg-yellow-600 rounded text-lg">新規登録する</button>
              </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="md:px-4 py-3">
                        <button type="button"
                          onclick="location.href='{{route('admin.owners.edit', ['owner'=> $owner->id])}}'" class=" text-white bg-yellow-400 border-0 py-2 px-4 focus:outline-none hover:bg-yellow-500
                          rounded ">編集</button>
                      </td>
